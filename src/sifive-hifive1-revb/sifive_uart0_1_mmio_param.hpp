/*
   Register and field offset and size definitions for peripheral sifive_uart0_1.
   SPDX-License-Identifier: Unlicense
*/

#ifndef SIFIVE_UART0_1_MMIO_PARAMS_HPP
#define SIFIVE_UART0_1_MMIO_PARAMS_HPP
